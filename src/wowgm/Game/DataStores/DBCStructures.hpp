...
#pragma pack(push, 1)
    struct ItemSparseEntry {
        ...
        std::uint32_t UnkMember23[10];
        std::uint32_t UnkMember24[10];
        std::uint32_t UnkMember25[10];
        std::uint32_t UnkMember26[10];
        std::uint32_t UnkMember27;
        std::uint32_t UnkMember28;
        std::uint32_t UnkMember29;
        float UnkMember30;
        std::uint32_t UnkMember31[5];
        std::uint32_t UnkMember32[5];
        std::uint32_t UnkMember33[5];
        std::uint32_t UnkMember34[5];
        std::uint32_t UnkMember35[5];
        std::uint32_t UnkMember36[5];
        std::uint32_t UnkMember37;
        const char* UnkMember38;
        const char* UnkMember39;
        const char* UnkMember40;
        const char* UnkMember41;
        const char* UnkMember42;
        std::uint32_t UnkMember43;
        std::uint32_t UnkMember44;
        std::uint32_t UnkMember45;
        std::uint32_t UnkMember46;
        std::uint32_t UnkMember47;
        std::uint32_t UnkMember48;
        std::uint32_t UnkMember49;
        std::uint32_t UnkMember50;
        std::uint32_t UnkMember51;
        std::uint32_t UnkMember52;
        std::uint32_t UnkMember53;
        std::uint32_t UnkMember54;
        std::uint32_t UnkMember55;
        std::uint32_t UnkMember56;
        std::uint32_t UnkMember57[3];
        std::uint32_t UnkMember58[3];
        std::uint32_t UnkMember59;
        std::uint32_t UnkMember60;
        float UnkMember61;
        std::uint32_t UnkMember62;
        std::uint32_t UnkMember63;
        std::uint32_t UnkMember64;
        float UnkMember65;
        std::uint32_t UnkMember66;
        std::uint32_t UnkMember67;
    };
#pragma pack(pop)
...
#pragma pack(push, 1)
    struct SpellEntry {
        ...
        std::uint32_t UnkMember15;
        float UnkMember16;
        std::uint32_t UnkMember17[2];
        std::uint32_t UnkMember18;
        std::uint32_t UnkMember19;
        const char* UnkMember20;
        const char* UnkMember21;
        const char* UnkMember22;
        const char* UnkMember23;
        std::uint32_t UnkMember24;
        std::uint32_t UnkMember25;
        std::uint32_t UnkMember26;
        std::uint32_t UnkMember27;
