...
namespace wowgm::protocol::world
{
    ...
    void WorldPacketCrypt::Init(const BigNumber& K)
    {
        ...
        HmacSha1 serverDecryptHmac(SEED_KEY_SIZE, (std::uint8_t*)ServerDecryptionKey);
        std::uint8_t* decryptHash = serverDecryptHmac.ComputeHash(K);

        std::uint8_t ClientEncryptionKey[SEED_KEY_SIZE] = { 0xCC, 0x98, 0xAE, 0x04, 0xE8, 0x97, 0xEA, 0xCA, 0x12, 0xDD, 0xC0, 0x93, 0x42, 0x91, 0x53, 0x57 };
